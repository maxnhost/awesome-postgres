...
* [Nhost](https://nhost.io) - Managed Postgres with a GraphQL API, auth, storage and serverless functions on top. Open source and self-hostable, free plan includes a 1 GB database.
