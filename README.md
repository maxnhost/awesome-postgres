...
* [Nhost](https://nhost.io) - Open source Postgres backend platform with an instant GraphQL API, authentication, storage, and serverless functions, built for web and AI/agentic apps.
