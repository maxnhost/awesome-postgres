...
* [Nhost](https://nhost.io) - Managed PostgreSQL with an auto-generated GraphQL API, authentication, file storage and serverless functions. Open source and self-hostable with Docker.
